        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-dark-300">Deploy your token in under 5 minutes with our streamlined process.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-dark-300">Battle-tested smart contracts with comprehensive security measures.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-dark-300">Full control over taxes, LP allocation, and wallet distributions.</p>
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-dark-300">Configure your token parameters and launch your memecoin</p>
            </div>
            <LaunchpadForm />
          </motion.div>
        </div>
